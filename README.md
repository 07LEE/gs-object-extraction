...
5. **Delete strays.** In the object preview, press **S**, then drag a box over the specks or click one. The selected Gaussians turn red and stay until you delete them: **Shift** adds to the selection, **Ctrl** takes away, **Esc** clears it, **X** or **Delete** removes it and **Ctrl+Z** undoes. A box takes everything under it at any depth, so draw it from an angle where the strays stand clear of the object.
...
| X or Delete, Ctrl+Z | Object preview: delete the selected Gaussians, undo | — |
